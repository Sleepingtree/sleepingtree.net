    ...
    return (
      <Container>
        ...
        <Container text floated='left'>
          This site was made with TypeScript, React and Semantic UI. The purpose of this site is to serve as a mixed personal and professional site.
          I consider myself more of a backend developer than front end, but hopefully that doesn't show too much.
          <Divider hidden />
        ...
        <Container text>
          ...
          and if you want to see the implementation details of both the bot repo that provides the status as well as the repo used to display the bot status they are public on my github. The
          back-end is used for more then just providing the status, and has many other integration points.
        </Container>
        <Divider hidden />
        <Image src={banner} />
      </Container>
